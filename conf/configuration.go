...
// SamlProviderConfiguration holds all the saml provider configuration relevant information
...
// ProviderConfiguration holds a config for oauth providers
...
// HasEvent checks if given event exists
// returns boolean
