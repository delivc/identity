...
func (a *API) loadInstanceConfig(w http.ResponseWriter, r *http.Request) (context.Context, error) {
	...
	claims := DelivcMicroserviceClaims{}
	...
	logEntrySetField(r, "delivc_id", claims.DelivcID)
	...
	ctx = withDelivcID(ctx, claims.DelivcID)
...
func (a *API) extractOperatorRequest(w http.ResponseWriter, req *http.Request) (context.Context, string, error) {
	...
	return withAdminUser(req.Context(), &models.User{ID: uuid.Nil, Email: "operator@delivc.com"}), token, nil
}
