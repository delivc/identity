...
// SystemUserID refs a empty UID
const SystemUserID = "0"

// SystemUserUUID the uuid of the systemuser
...
// NewSystemUser creates a new SuperAdmin
...
// BeforeCreate is a hook that happens before the db insert
func (u *User) BeforeCreate(tx *pop.Connection) error {
	return u.BeforeUpdate(tx)
}

// BeforeUpdate is a hook that happens before the db update
